...
begin
   ...
   else retval := n + sum_of_int__rec(n - 1);  end; 
end; 
...
methode Norme2 of TPoint3D(): float; 
begin
   //retval := 0; 
   //(retval) := 0; 
   //retval := this -> Trace(); 
